        ...
        <n-grid-item>
          <n-card title="盈利能力" size="small">
            <n-grid :cols="2" :x-gap="12" :y-gap="8" responsive="screen">
              ...
              <n-grid-item><n-statistic label="营收增长" :value="fmtPct(data.revenue_growth)" /></n-grid-item>
              <n-grid-item><n-statistic label="净利润" :value="fmtMoney(data.net_profit)" /></n-grid-item>
              <n-grid-item><n-statistic label="扣非净利润" :value="fmtMoney(data.deducted_net_profit)" /></n-grid-item>
        ...
        <n-grid-item>
          <n-card title="偿债能力" size="small">
            <n-grid :cols="2" :x-gap="12" :y-gap="8" responsive="screen">
              ...
              <n-grid-item><n-statistic label="流动比率" :value="fmtNumber(data.current_ratio)" /></n-grid-item>
              <n-grid-item><n-statistic label="速动比率" :value="fmtNumber(data.quick_ratio)" /></n-grid-item>
              <n-grid-item><n-statistic label="经营现金流" :value="fmtMoney(data.operating_cashflow)" /></n-grid-item>
              <n-grid-item><n-statistic label="货币资金" :value="fmtMoney(data.cash)" /></n-grid-item>
              <n-grid-item><n-statistic label="有息负债" :value="fmtMoney(data.interest_debt)" /></n-grid-item>
            </n-grid>
          </n-card>
        </n-grid-item>
        <n-grid-item>
          <n-card title="估值指标" size="small">
            <n-grid :cols="2" :x-gap="12" :y-gap="8" responsive="screen">
              <n-grid-item><n-statistic label="PE(TTM)" :value="fmtNumber(data.pe_ttm)" /></n-grid-item>
              <n-grid-item><n-statistic label="PB" :value="fmtNumber(data.pb)" /></n-grid-item>
              <n-grid-item><n-statistic label="PEG" :value="fmtNumber(data.peg)" /></n-grid-item>
              <n-grid-item><n-statistic label="股息率" :value="fmtPct(data.dividend_yield)" /></n-grid-item>
              <n-grid-item><n-statistic label="总市值" :value="fmtMoney(data.market_cap)" /></n-grid-item>
              <n-grid-item><n-statistic label="总股本" :value="fmtMoney(data.total_shares)" /></n-grid-item>
            </n-grid>
          </n-card>
        </n-grid-item>
        <n-grid-item>
          <n-card title="运营指标" size="small">
            <n-grid :cols="2" :x-gap="12" :y-gap="8" responsive="screen">
              <n-grid-item><n-statistic label="存货周转天数" :value="fmtNumber(data.inventory_days)" /></n-grid-item>
              <n-grid-item><n-statistic label="应收周转天数" :value="fmtNumber(data.ar_days)" /></n-grid-item>
              <n-grid-item><n-statistic label="商誉" :value="fmtMoney(data.goodwill)" /></n-grid-item>
            </n-grid>
          </n-card>
        </n-grid-item>
        <n-grid-item>
          <n-card title="风险提示" size="small">
            <n-grid :cols="2" :x-gap="12" :y-gap="8" responsive="screen">
              ...
              <n-grid-item><n-statistic label="审计意见变更" :value="data.auditor_change || '未变更'" /></n-grid-item>
            </n-grid>
          </n-card>
        </n-grid-item>
      </n-grid>
